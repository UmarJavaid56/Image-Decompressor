...
vlog -sv -work my_work +define+DISABLE_DEFAULT_NET $rtl/milestone2_Top.sv
vlog -sv -work my_work +define+DISABLE_DEFAULT_NET $rtl/milestone2_FetchandWrite.sv
vlog -sv -work my_work +define+DISABLE_DEFAULT_NET $rtl/milestone2Calc.sv
vlog -sv -work my_work +define+DISABLE_DEFAULT_NET $rtl/dual_port_RAMc.v
vlog -sv -work my_work +define+DISABLE_DEFAULT_NET $rtl/dual_port_RAMs_prime.v
vlog -sv -work my_work +define+DISABLE_DEFAULT_NET $rtl/dual_port_RAMt.v
